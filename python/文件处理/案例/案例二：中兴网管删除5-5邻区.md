...
data1_t = data1_1.iloc[0:4]
data1_1["moId01"]=data1["moId"].str.replace("460-11-","").str.replace("460-01-","").str.replace("Anr-","")
data1_2=data1_1[data1_1["moId01"].isin(list)].drop(["moId01"],axis = 1)
data1_3 = pd.concat([data1_t ,data1_2] , ignore_index = True)
...
data2_2=data2[data2["ldn01"].isin(list)].drop(["ldn01"],axis = 1)
data2_3 = pd.concat([data2_t ,data2_2] , ignore_index = True)
...
data3_2=data3[data3["moId01"].isin(list)].drop(["moId01"],axis = 1)
data3_3 = pd.concat([data3_t ,data3_2] , ignore_index = True)
...
data1_3.to_excel(writer,sheet_name = "ExternalNRCellCU",index = False)
data2_3.to_excel(writer,sheet_name = "SsbMeasInfo",index = False)
data3_3.to_excel(writer,sheet_name = "NRCellRelation",index = False)
writer.save()
```
